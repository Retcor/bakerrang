...
const oauthTarget = import.meta.env.VITE_OAUTH_TARGET || 'sign'
...
export const AppProviders = ({ children }) => <AuthProvider apiClient={apiClient} apiBaseUrl={apiBaseUrl} oauthTarget={oauthTarget}><ThemeBridge>{children}</ThemeBridge></AuthProvider>
