...
export const POLYGLOT_PWA_OPTIONS = {
  ...
  manifest: {
    id: '/',
    name: 'Polyglot — BakerRang',
    short_name: 'Polyglot',
    description: 'Speak, and hear it said in another language in your own voice.',
    start_url: '/',
    scope: '/',
    display: 'standalone',
    theme_color: '#161514',
...
export default defineConfig({ plugins: [themeBoot, react(), VitePWA(POLYGLOT_PWA_OPTIONS)] })
