...
import { StoriesProvider } from './state/StoriesProvider.jsx'

export const apiBaseUrl = import.meta.env.VITE_API_BASE_URL || 'http://localhost:8080'
const oauthTarget = import.meta.env.VITE_OAUTH_TARGET || 'storybook'
...
export const AppProviders = ({ children }) => (
  <AuthProvider apiClient={apiClient} apiBaseUrl={apiBaseUrl} oauthTarget={oauthTarget}>
    <ThemeBridge><StoriesProvider apiClient={apiClient} apiBaseUrl={apiBaseUrl}>{children}</StoriesProvider></ThemeBridge>
  </AuthProvider>
)
