...
export default function SitePreviewFrameLayout ({ children }: Readonly<{ children: ReactNode }>) {
  return <div className={tenantFontVariables} style={{ minHeight: '100%' }}>{children}</div>
}
