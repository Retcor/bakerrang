...
const AudioRecorder = ({ className, setAudioBlob, setAudioURL, setAudioBase64 }) => {
  ...
  return (
    <div className={className}>
      {!isRecording
        ? (
          <button onClick={startRecording} className='bg-gray-700 rounded-full text-white hover:text-blue-500 w-10 h-10 flex items-center justify-center p-0'>
        ...
        : (
          <button onClick={stopRecording} className='bg-gray-700 rounded-full w-10 h-10 flex items-center justify-center p-0'>
