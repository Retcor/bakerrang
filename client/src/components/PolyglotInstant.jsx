  ...
  return (
    <ContentWrapper title='Polyglot Instant'>
      <p className={`text-xs font-medium ${isDark ? 'text-theme-secondary-dark' : 'text-theme-secondary-light'}`}>
        Polyglot but instant! Voice used will be the primary voice set in the <a href='/account' className='text-blue-400 hover:text-blue-500 hover:underline transition-all duration-200'>Account settings</a> or the first voice found if there is no primary.
      </p>
      ...
      <div className='flex justify-center mt-4'>
        <div className='w-full flex justify-center'>
          ...
          <GoogleSpeechToText setSpeechToText={setSpeechToText} lang={inputLangCode} buttonClassName='!w-64 !h-64' isLoading={isProcessing} />
