...
const GoogleLogin = ({ onClick }) => {
  ...
  return (
    <a
      ...
      onClick={() => onClick()}
    >
      <div className='absolute inset-0 bg-gradient-to-r from-amber-500/10 to-yellow-500/10 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-300' />
      <img
        src={google}
        alt='Google Logo'
