    ...
    <div className='grid grid-cols-2 gap-2 p-3'>
      {apps.map((app) => (
        <button
          ...
          className={`flex flex-col items-center justify-center p-4 rounded-xl transition-all duration-200 hover:scale-105 group ${isDark ? 'hover:bg-white/10' : 'hover:bg-black/8'}`}
        >
