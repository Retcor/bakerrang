...
try {
    ...
    Test-Case 'fixed smoke paths/markers for every service and invalid status URL rejected' {
        ...
        $assertions = @('Healthy', 'StatusOnly', 'UserAgent', 'ClientRoot', 'ClientRoot', 'ClientRoot', 'ClientRoot')
        $publicUrls = @('https://api.bakerrang.com/health', 'https://portal.bakerrang.com/', 'https://sites.bakerrang.com/robots.txt', 'https://bakerrang.com/', 'https://launch.bakerrang.com/', 'https://storybook.bakerrang.com/', 'https://polyglot.bakerrang.com/')
